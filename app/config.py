...
class Settings(BaseSettings):
    service_role: str = "cost-service"
    service_name: str = "cost_service"
    service_title: str = "Cost service"
    service_description: str = "Owns token cost ledger, model rates, electricity settings and FinOps summaries."
